...
<!--        <link href="css/responsive.css" rel="stylesheet">  -->
    ...
    <body>
        ...
        <section class="slider_area row m0">
            <div class="slider_inner">
                <div class="camera_caption">
                    <h2 class="wow fadeInUp animated">The best way to shop online</h2>
                    <h5 class="wow fadeIn animated" data-wow-delay="0.3s">Everything  you need in one place for Black Friday and cyber Monday</h5>
        ...
        <section class="best_business_area row">
            <div class="check_title wow fadeInUp" data-wow-delay="0.7s" id="product-list">
                <h2>Product List</h2>
            </div>
        ...
        <footer class="footer_area row">
            <div class="container custom-container">
                ...
                <div class="copy_right_area">
                    <h4 class="copy_right">© Copyright 2022 OSTRISH WebApp | All Rights Reserved</h4>
                </div>
            </div>
        </footer>
